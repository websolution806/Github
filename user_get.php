...
if(isset($_POST['submit'])) {
	...
	echo   $user_name = $contentq['user']['username'];
		echo "<br>";
	echo $user_full_name= $contentq ['user']['full_name'];
		echo "<br>";
	echo  $porfile_pic_url = $contentq['user']['profile_pic_url']; 
		echo "<br>";
	echo  $followed_by= $contentq['user']['followed_by']['count']; 
		echo "<br>";
	echo $follows = $contentq['user']['follows']['count']; 
		echo "<br>";
	echo $profile_hd_url = $contentq['user']['profile_pic_url_hd']; 
		echo "<br>";
		...
		foreach ($list as $line)
		  ...
		  echo '<a href="http://localhost:8080/instagram/hello.php" target="_blank">Download CSV</a>';
